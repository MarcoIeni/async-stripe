...
impl Price {
    ...
    pub fn list<'a>(client: &'a Client, params: &'a ListPrices<'a>) -> Response<'a, List<Price>> {
    ...
    pub fn create<'a>(client: &'a Client, params: CreatePrice<'a>) -> Response<'a, Price> {
